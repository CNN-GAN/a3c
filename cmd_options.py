...
def get_arguments(argv):
	...
	parser.add_argument('--episodes_per_batch', default=5, type=int, help='number of episodes to batch for TRPO updates', dest='episodes_per_batch')
	parser.add_argument('--trpo_max_rollout', default=40, type=int, help='max rollout steps per trpo episode', dest='max_rollout')
